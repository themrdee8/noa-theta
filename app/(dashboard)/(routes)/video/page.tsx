  ...
  return (
    <div>
      <Header
        ...
        description="Generate videos with Noa"
        icon={Video}
      ...
      <div className="px-4 lg:px-8">
        ...
        <div className="space-y-4 mt-4">
          ...
          {!video && !isLoading && <Empty label={"How may I assist you?"} />}
          {video && (
            <video
              className="w-full aspect-video border bg-black mt-8 rounded-lg"
              controls
            >
              <source src={video} />
            </video>
